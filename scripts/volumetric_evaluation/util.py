...
def _get_default_args(input_path):
    ...
    parser.add_argument("-i", "--input_path", type=str, default=input_path, help="Path to volume.")
    ...
    parser.add_argument("--ais", action="store_true", help="Whether to perforn 3d ais.")
    parser.add_argument("--int", action="store_true", help="Whether to perform 3d interactive instance segmentation.")
    parser.add_argument(
        "-p", "--prompt_choice", default="box", type=str, help="The choice of prompt to start interactive segmentation."
    )
    parser.add_argument("--species", type=str, default=None, help="Relevant for MitoEM.")
