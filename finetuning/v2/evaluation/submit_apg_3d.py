...
def _variants(args: argparse.Namespace) -> dict:
    """The variants to evaluate: an explicit set, a sweep over one parameter, or the default ablation."""
...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    print(f"Submitting {len(datasets)} jobs with the variants {list(variants)} to '{job_folder}'.")
