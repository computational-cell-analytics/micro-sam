...
from obtain_em_datasets import get_generalist_em_loaders
...
def finetune_em_generalist(args):
    ...
    train_loader, val_loader = get_generalist_em_loaders(input_path=args.input_path, patch_shape=patch_shape)

    # this class creates all the training data for a batch (inputs, prompts and labels)
    convert_inputs = sam_training.ConvertToSamInputs()

    checkpoint_name = "generalist_em_sam"
    # the trainer which performs training and validation (implemented using "torch-em")
...
def main():
    parser = argparse.ArgumentParser(description="Finetune Segment Anything for the EM datasets.")
    parser.add_argument(
