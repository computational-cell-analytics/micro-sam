...
def show_wrong_file_warning(file_path):
    ...
    if msgbox.clickedButton() == ignore_btn:
        ...
        # select new file and create new file can be done in the same diag
        # in case of file creation, user has to first create the file as new folder and then select it.
