...
def mask_data_to_segmentation(
    ...
    Args:
        masks: The outputs generated by `AutomaticMaskGenerator`, other classes from `micro_sam.v1.instance_segmentation`,
            or from `micro_sam.v1.inference` functions. Only supported for output_mode=binary_mask.
