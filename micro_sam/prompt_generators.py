...
class PointAndBoxPromptGenerator:
    def __init__(self, n_positive_points, n_negative_points, dilation_strength,
        ...
        if isinstance(n_positive_points, int):
            self.n_positive_points = n_positive_points
        else:
            self.n_positive_points = np.random.randint(n_positive_points[0], n_positive_points[1] + 1)

        if isinstance(n_negative_points, int):
            self.n_negative_points = n_negative_points
        else:
            self.n_negative_points = np.random.randint(n_negative_points[0], n_negative_points[1] + 1)
