...
tooltips = {
  ...
  "training": {
    "checkpoint": "Create a checkpoint in form of a saved model state to resume training from.",
    "device": "Select the computational device to use for processing.",
    "initial_model": "Select a model as a starting point for training.",
    "label_key": "Define the key within your data that corresponds to the image segmentation labels (e.g. \"*.tif\").",
    "label_path": "Specify the path to the directory containing the labels used for training the model.",
    "label_path_val": "Specify the path to the directory containing the labels used for validation.",
    "name": "Name of the new model.",
    "patch": "Define the size of image patches used during the training process.",
    "raw_key": "Define the key within your data that corresponds to the raw image data. (e.g. \"*.tif\").",
    "raw_path": "Provide the path to the folder containing the training images.",
    "raw_path_val": "Provide the path to the folder containing the validation images.",
    "segmentation_decoder": "Choose whether to use segmentation decoder or not.",
    "output_path": "Specify the path where you want to save the trained model after the training process.",
    "n_epochs": "Define the number of training iterations (epochs) for your model.",
